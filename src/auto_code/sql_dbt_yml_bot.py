...
# MAKE BASE MODEL 
class SeniorAnalyticsEngineer(CoreAssistant):
    """
    Auto Code
    ---------
    ...
    """
    def __init__(self):
        super().__init__(assistant_name="Code Refinement for SeniorAnalyticsEngineer")
        ...
        self.instructions = (
            "You are an expert with the DBT tool, excellent at reading and writing SQL"
            "You can also read and write yaml for DBT very well"
