...
# MAKE BASE MODEL 
class GoogleWebClientBot(CoreAssistant):
    """
    Auto Code
    ---------
    ...
    """
    def __init__(self):
        super().__init__(assistant_name="Code Refinement for GoogleWebClientBot")
        self.temperature = 0.3  # Leave some room for inference
        self.description = "Programming assistant bot for code refinement and optimization bot. Just write code"
        self.instructions = (
            "You are an expert web developer and are genuis at programming things for the google tech stack"
