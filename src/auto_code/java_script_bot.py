...
# MAKE BASE MODEL 
class SeniorJavaScriptEngineer(CoreAssistant):
    """
    Auto Code
    ---------
    ...
    """
    def __init__(self):
        super().__init__(assistant_name="Code Refinement for Java Script")
        self.temperature = 0  # Leave some room for inference
        self.description = "You are a very experienced, senior java script engineer. Just write code"
        self.instructions = (
            "No chat response needed, just respond with the code. No backticks needed"
            "Focus on refactoring and refining javascript code."
            "Provide feedback and comments where needed"
            "You're very good at modern ui/ux design implementation as well"
    ...
    def generate(self, prompt: str) -> str:
        ...
        completion = self.client.chat.completions.create(
            model='gpt-4o', # For javascript bot, use a more expensive model. Only use as necessary
